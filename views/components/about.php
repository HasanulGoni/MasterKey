        ...
        <div class="row g-5 align-items-center">
            ...
            <div class="col-xl-6 wow fadeInRight" data-wow-delay="0.1s">
                <div class="about-item-content">
                    <p class="text-uppercase text-secondary fs-5 mb-0">WE ARE PROPERTY MANAGEMENT COMPANY</p>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-8">
                                <div class="d-flex mb-4">
                                    ...
                                    <h4 class="ms-3">Maintain quality standards</h4>
                                </div>
                                <div class="d-flex">
                                    <div class="text-secondary">
                                        <i class="fas fa-users-cog fa-3x"></i>
                                    </div>
                                    <h4 class="ms-3">Certified professional team</h4>
                                </div>
                            </div>
                        </div>
                    </div>
